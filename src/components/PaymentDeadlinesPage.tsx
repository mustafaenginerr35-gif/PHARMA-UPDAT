            ...
            <div className="flex-1 p-6 border-b md:border-b-0 md:border-l border-border/50">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-black text-lg">جاهزية التسديد (Cash Flow)</h3>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                  <div className="text-[10px] font-black text-muted-foreground uppercase mb-1">إجمالي المطلوب تسديده</div>
                ...
                <div className="col-span-2 lg:col-span-1 border-t lg:border-t-0 lg:border-r border-border/50 pt-4 lg:pt-0 lg:pr-6">
                  <div className="text-[10px] font-black text-muted-foreground uppercase mb-1">الفرق (فائض / عجز)</div>
